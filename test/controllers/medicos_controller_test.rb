...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference("Medico.count") do
      post medicos_url, params: { medico: { experience: @medico.experience, name: @medico.name } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { experience: @medico.experience, name: @medico.name } }
